...
-- 커밋 : 수정, 삭제, 갱신 등 작업이 완료되면 DB 에 최종 반영
-- commit;
...
INSERT INTO professor (prof_id, name, email, dept_id, hire_year)
VALUES ('p099', '홍교수', 'hong@test.com', 'CSE', 2005)
;
-- ============================================================
-- 예제 08: 학생 데이터 삽입
...
-- SQLite는 PRIMARY KEY 생성시, NOT NULL을 같이 포함한다.
-- PRIMARY KEY : UNIQUX, NOT NULL!!
...
-- INSERT INTO student (student_id, name, birth_year, dept_id, grade)
-- VALUES ('S9991', '유령학생', 2002, 'GHOST', 1);

INSERT INTO student (student_id, name, birth_year, dept_id, grade)
VALUES ('S9990', '실제학생', 2002, 'CSE', 1);
